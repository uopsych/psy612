...
Recall from lecture that bootstrapping is a general purpose tool to use whenever you can't make assumptions about how a statistic is distributed - as Sara put it, it's the *windex* of the statistical world. Some examples include:   

1. Highly Unequal Groups   
2. Non-normal distributions (e.g., correlations)   
3. Estimate variability around something that doesn't have its own Standard Error (e.g., $R^2$)
