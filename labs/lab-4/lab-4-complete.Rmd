...
```{r}
# multiple regression
mini_model_1 <- lm(conspiracy ~ paranoia + delusions, data = df)

summary(mini_model_1)
```
...
```{r}
# ceate model_2
mini_model_2 <- lm(conspiracy ~ paranoia + delusions + uniqueness + control, data = df)

# compare models
comparison <- anova(mini_model_1, mini_model_2)
comparison

# r_squared
comparison$`Sum of Sq`[2] / comparison$RSS[1]

# delta_r_squared
summary(mini_model_2)$r.squared - summary(mini_model_1)$r.squared
```
