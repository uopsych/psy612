...
```{r}
# import data
data <- import(file     = "https://raw.githubusercontent.com/uopsych/psy612/master/labs/lab-4/data_htwtage.csv",
               setclass = "tibble")
...
Visualize the relationship between age and weight. Let's also label the data points with the names of the participant.
...
Regress weight on age (i.e., Y = Weight, X1 = Age). Standardize the variables in the model. 
