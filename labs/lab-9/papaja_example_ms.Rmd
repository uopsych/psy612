...
# tidy the data
b5 <- b5 %>% 
  # convert education to a factor and strings to the numbers
  mutate(
    education = as.factor(education),
    education = case_when(education == 1 ~ "Some HS",
