...
Now we have a nicely formatted APA-style table that is fully reproducible. We can also reference the table within the `{papaja}` .Rmd with `\@ref(tab:descrips-tab)` as you'll see when we walk through the example script.
