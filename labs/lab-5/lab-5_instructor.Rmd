...
Today's lab will focus on one-way ANOVA. We will start with the traditional way like Sarah did in class on Thursday. However, the majority of the lab time afterwards will focus on running an ANOVA as a linear regression with a categorical predictor. Though we haven't talked about it yet, the content will be covered in detail during next week's class.
...
We have just reviewed how to do generate a traditional ANOVA table. We will next talk about how to perform ANOVA within a linear regression framework, though this will give us the same information we already got from our regression model. 
