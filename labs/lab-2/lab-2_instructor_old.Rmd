...
#### Q1:
>**Question:** What does a standard error of the estimate of `r round(model_summary$sigma, 2)` mean? Is that good?
...
Another way we can evaluate our regression model is by extracting the coefficient of determination, $R^2$. This represents the proportion of variance explained by the model. Like the residual standard error, we need to use the summary function to get it:
