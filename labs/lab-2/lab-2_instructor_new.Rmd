...
* We already calculated `ss_model` above, so we just need to divide it by the model degrees of freedom, which is equal to the number of regression parameters minus 1. 
