...
* Recall as Sara mentioned in lecture that correlations can be considered both a descriptive and inferential statistic. So far we've talked about how to calculate correlations, but we haven't mentioned how to assess whether correlations are statisticall meaningful. 
