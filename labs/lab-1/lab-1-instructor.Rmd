...
ggplot(data = mtcars, aes(x = mpg, y = hp)) +
  ...
  labs(x = "marshmellows per grape", y = "harry potter")+
  theme_classic()

ggplot(data = mtcars, aes(x = mpg, y = hp)) +
  geom_point(alpha=1, color="lightpink") +
  geom_smooth(method = "lm", color ="lightblue", show.legend = TRUE, se = FALSE) +
  labs(title    = "Scatterplot of MPG by Horse Power",
       x        = "Miles Per Gallon",
       y        = "Horse Power") +
  # set theme
  theme_dark()
...
ggplot(data = mtcars, aes(x = mpg, y = hp)) + # establish the background of the painting, data from mtcars, x-axis is mpg and y-axis is hp
  geom_point(shape=8, size=4) + # add a layer of data points (mpg,hp)
  geom_smooth(method = "lm", color="lightblue", se=FALSE) + # draw linear-model line
  ggtitle("Horsepower Baby") +
  theme_tufte()
```
...
health <- import("https://raw.githubusercontent.com/uopsych/psy612/master/labs/lab-2021/lab-1/data/consc_health.csv")
