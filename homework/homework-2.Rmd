...
You're interested in studying the joint and combined influence of school success, ses, and friendship quality on the happiness of adolescents. Using the dataset `homework-happy_d`, build three regression models. Each model should use happiness as the outcome variable and be nested within the subsequent model. That is, you should with one predictor and add one additional predictor at a time. 
