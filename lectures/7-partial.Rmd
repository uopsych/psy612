...
the semi-partial correlation betewen parent SES and GPA controlling for peer relationships is a (not c), divided by all of GPA
...
$$\large pr_1=r_{Y1.2} = \frac{r_{Y1}-r_{Y2}r_{{12}}}{\sqrt{1-r^2_{Y2}}\sqrt{1-r^2_{12}}} = \frac{r_{Y(1.2)}}{\sqrt{1-r^2_Y2}}$$
---

### What happens if X1 and X2 are uncorrelated?

How does the semi-parital correlation compare to the zero-order correlation?
...
The partial correlationis most often used when some third variable, Z, is a plausible explanation of the correlation between X and Y
