...
```{r}
noise_lsm = emmeans::lsmeans(time_rg, c("Noise"))
...
```{r}
all_lsm = emmeans::lsmeans(time_rg, c("Noise", "Speed"))
pairs(all_lsm, adjust = "holm")
```
...
Interaction tests whether slope or difference in means changes. 
